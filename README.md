...
👉 **[Descargar AppTaxis v1.0.3 (.apk)](https://github.com/Pau-Balsach/AppTaxis-mobile/releases/latest/download/app-arm64-v8a-release.apk)**
...
```text
lib/
├── models/      # Definición de objetos de datos (Admin, Conductor, Viaje, Cliente)
